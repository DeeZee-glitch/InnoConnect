...
function Feeds({ allFormData, setAllFormData, touched }) {
    ...
    <>
      <MDBox>
        ...
        <TextField
          ...
          error={touched && !allFormData.feed?.feedName} // Shows an error state if the field is empty
          helperText={touched && !allFormData.feed?.feedName ? "Feed Name is required" : ""} // Helper text for validation feedback
        />
        <TextField
          label="Active"
          name="feedIsActive"
      ...
      <MDBox sx={{ marginTop: 3 }}>
        ...
        >
          ...
          <span style={{ fontWeight: "normal", color: "#888", fontSize: "0.8em" }}>
            (Multiple Monitors can also be added from Feeds page)
          </span>
        </Typography>
        <TextField
          label="Monitor Name"
          ...
          fullWidth
          required // Indicates this field is mandatory
          error={touched && !allFormData.monitor?.auditSystemName} // Shows an error state if the field is empty
          helperText={
            touched && !allFormData.monitor?.auditSystemName ? "Monitor Name is required" : ""
        ...
        <TextField
          ...
          fullWidth
          required // Indicates this field is mandatory
          error={touched && !allFormData.monitor?.measureFieldPath} // Shows an error state if the field is empty
          helperText={
            touched && !allFormData.monitor?.measureFieldPath
              ? "Measure Field Path is required"
              : ""
          } // Helper text for validation feedback
        />
        <TextField
      ...
      <MDBox sx={{ marginTop: 3 }}>
        ...
        >
          Monitor Condition{" "}
          <span style={{ fontWeight: "normal", color: "#888", fontSize: "0.8em" }}>
            (Multiple Conditions can also be added from Feeds page)
          </span>
        </Typography>
        <TextField
