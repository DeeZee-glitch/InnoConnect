...
export default function Rules({
  ...
  const handleRuleDefChange = (event) => {
    ...
    if (name === "evaluatorId") {
      const selectedEvaluator = evaluators.find((evaluator) => evaluator.evaluatorId === value);
      setEvaluatorName(selectedEvaluator.evaluatorName);
    }
  };
  ...
  const handleRuleActionChange = (event) => {
    ...
    if (name === "executorId") {
      // Find the selected executor in the executors array.
      const selectedExecutor = executors.find((executor) => executor.executorId === value);
      setExecutorName(selectedExecutor.executorName);
    }
  };
  ...
  return (
    <>
      <MDBox>
        ...
        <Typography
          sx={{ marginTop: 2, fontWeight: 600, color: "#1A73E8" }}
          variant="subtitle1"
          align="left"
        >
          Rule
        ...
        <TextField
          ...
          error={touched && !allFormData.rule?.ruleName} // Shows an error state if the field is empty
          helperText={touched && !allFormData.rule?.ruleName ? "Rule Name is required" : ""} // Helper text for validation feedback
        />
        <TextField
          label="Monitor Feed"
      ...
      <MDBox sx={{ marginTop: 3 }}>
        ...
        >
          Rule Definition{" "}
          <span style={{ fontWeight: "normal", color: "#888", fontSize: "0.8em" }}>
            (Multiple Definitions can also be added from Rule page)
          </span>
        </Typography>
        <TextField
          ...
          required // Indicates this field is mandatory
          error={touched && !allFormData.ruleDefinition?.definitionLabel} // Shows an error state if the field is empty
          helperText={
            touched && !allFormData.ruleDefinition?.definitionLabel
      ...
      <MDBox sx={{ marginTop: 3 }}>
        ...
        >
          Rule Action{" "}
          <span style={{ fontWeight: "normal", color: "#888", fontSize: "0.8em" }}>
            (Multiple Actions can also be added from Rules Page)
          </span>
        </Typography>
        ...
        <Typography sx={{ textAlign: "left" }}>
          <span style={{ fontWeight: "normal", color: "#4CAF50", fontSize: "0.8em" }}>Note: </span>
          <span style={{ fontWeight: "normal", color: "#888", fontSize: "0.8em" }}>
            Configure Rule Actions from Rules page
          </span>
        </Typography>
      </MDBox>
      {/* <MDBox sx={{ marginTop: 3 }}>
        ...
        >
          Rule Escalation{" "}
          <span style={{ fontWeight: "normal", color: "#888", fontSize: "0.8em" }}>(Optional)</span>
        </Typography>
        <TextField
          label="Send SMS"
          select
      ...
      <MDBox sx={{ marginTop: 3 }}>
        <Accordion sx={{ "&.MuiPaper-root": { boxShadow: "none", borderBottom: "none" } }}>
          <AccordionSummary expandIcon={<ArrowDownwardIcon />}>
            <Typography sx={{ fontWeight: 600, color: "#1A73E8" }} variant="subtitle1" align="left">
              Rule Escalation{" "}
              <span style={{ fontWeight: "normal", color: "#888", fontSize: "0.8em" }}>
                (Optional)
              </span>
